    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
           ZeemLearn aims to be a global leader in online education, delivering
          ...
          to lead and excel in their respective fields.  ZeemLearn envisions a
      ...
      <div className="flex flex-col md:flex-row justify-center items-center max-w-5xl mx-auto gap-8">
        ...
        <div className="w-full md:w-1/2">
          ...
          <p className="text-base md:text-lg leading-relaxed">
            The mission of  ZeemLearn is to provide comprehensive online courses
            ...
            necessary for personal and professional growth.  ZeemLearn endeavors
